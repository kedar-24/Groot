  ...
  return (
    <div className="max-w-5xl mx-auto p-6">
      ...
      {events.map(event => {
        ...
        return (
          <div key={event._id} className="mb-8 border border-gray-200 rounded-2xl p-6 bg-white shadow-md">
            {expandedEventId === event._id ? (
                    ...
                    <>
                      <ul className="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-4">
                        {paginatedParticipants.map(user => (
                          ...
                          >
                            <img
                              src={user.image?.startsWith('http') ? user.image : `/uploads/${user.image}`}
                              alt={user.username}
                              width={48}
                              height={48}
                      ...
                      <textarea
                        ...
                        placeholder="Write your email message to all participants..."
                      ...
                      <button
                        ...
                        className="bg-green-700 text-white px-6 py-2 rounded-lg disabled:opacity-50"
                      >
              ...
              <>
                ...
                <p className="text-sm text-gray-500 mb-4">
                  🧑‍🤝‍🧑 <span className="font-semibold text-green-700">{event.participants.length}</span>{' '}
